...
exports.getData = exports.app = undefined;

var _config = __webpack_require__(4);

var _config2 = _interopRequireDefault(_config);

var _welogin = __webpack_require__(10);

var _welogin2 = _interopRequireDefault(_welogin);
...
var loginConfig = {
    ...
    // 业务登录唯一ID
    weapp_type: _config2.default.weapp_type
};

// welogin模块初始化操作
_welogin2.default.prepare(app, loginConfig);

// API请求默认回调函数
var none = function none() {};

function getData() {
    var _success = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : none;

    var _fail = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : none;
	...
	var HTMLCanvas=(function(_super){
		function HTMLCanvas(type){
			...
			if (type==="2D" || (type==="AUTO" && !Render.isWebGL)){
				...
				if ( !window.hasCanvasCreate ) {
					this._source = canvas
					window.hasCanvasCreate = true;
				}
...
ctx.font = "24px";
ctx.fillStyle = '#000';
ctx.fillText(text, (width - ctx.measureText(text).width) / 2, (height - 24) / 2);
...
*	@desc 设置当前最大 的请求数
*/
app.MAX_REQUEST_COUNT = app.MAX_REQUEST_COUNT || 5;
/*
...
var Deeprequest = __webpack_require__(8);
var Strings     = __webpack_require__(9);
var LineQueue   = __webpack_require__(7);
